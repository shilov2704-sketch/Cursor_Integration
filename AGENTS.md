...
- Если пользователь просит создать баг — создавай сразу в этом же прогоне. Не предлагай открыть Web или Desktop. Не задавай уточняющих вопросов, из‑за которых работа встанет до ответа в другом чате.
...
Тег `@Cursor` в треде про дефект / «создай баг» / «заведи баг» — это уже просьба создать. Не спрашивай подтверждение и не проси открыть Web или Desktop.
...
Создай Bug сразу (MCP или скрипт). В финальном сообщении обязательно дай ID и ссылку `https://melston.visualstudio.com/HubEx/_workitems/edit/{id}` — её увидят в уведомлении Teams, без открытия Cursor.
